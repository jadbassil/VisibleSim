#ifndef GoalCover2DBlockCode_H_
#define GoalCover2DBlockCode_H_
...
class GoalCover2DBlockCode : public Catoms3DBlockCode {
private:
    int distance;
    Catoms3DBlock *module;
    set<Cell3DPosition> myArea;
    Cell3DPosition areaRoot;
    Cell3DPosition parent;
    int borderSize{0};
    map<Cell3DPosition, set<Cell3DPosition>> T;

    int countNodes(Cell3DPosition node,  bool& isBorder, int c = 0);
    pair<Cell3DPosition, Cell3DPosition> findCut(Cell3DPosition &node);
    Cell3DPosition cut(Cell3DPosition &node);
    void partition(Cell3DPosition &node, int k);
    void cleanTree();
    void updateTree();
    void highlightRegion(int c);
    Cell3DPosition findParent(Cell3DPosition &node);
    Cell3DPosition findRoot(Cell3DPosition node);
    Cell3DPosition entryPoint;
public :
    GoalCover2DBlockCode(Catoms3DBlock *host);
    ~GoalCover2DBlockCode() {};
    ...
    void setAreaBase(Cell3DPosition &start);
    bool cellOnBorder(Cell3DPosition pos);
    map<Cell3DPosition, set<Cell3DPosition>> buildTree();
...
/** needed to associate code to module                                      **/
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new GoalCover2DBlockCode((Catoms3DBlock*)host));
    };
/*****************************************************************************/
};

#endif /* GoalCover2DBlockCode_H_ */
